...
class Searchbar: UIView, UITextFieldDelegate {
    ...
    open var textInput: CMaterialTextField!
    // Delegation
    ...
    public var borderColorValue: UIColor = .lightGray
    public var searchbarHint = "Search"
    ...
    private func initUI() {
        ...
        // Set up textField
        textInput = CMaterialTextField(hint: searchbarHint, textColor: foregroundColor, font: Fonts.Regular.Regular16(), bgColor: self.backgroundColor ?? .white, delegate: self)
